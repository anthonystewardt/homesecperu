<x-app-layout>
    <x-slot name="header">
        ...
        <main class="container mx-auto  h-screen my-10">
            <div class="flex w-full justify-start">
                <a href="{{ route('dashboard.gallery.index') }}" class="bg-white px-4 py-2 rounded-lg shadow-xl hover:shadow-2xl transition ease-in flex items-center gap-2">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
            ...
            <form action="{{ route('dashboard.gallery.store') }}" method="POST"  class="border-dashed p-2 rounded-lg">
                 @csrf
              <div class="mt-5">
